  ...
  const slides = [
    {
      ...
      subtitle:
        "High-quality caps built for style and durability. Perfect for casual outings, sports, and everyday confidence.",
      cta: "Explore Caps",
    ...
    },
    {
      ...
      subtitle:
        "Step up your game with our latest collection of urban footwear designed for comfort.",
      cta: "View Shoes",
      color: "bg-[#A55536]",
    },
    {
      ...
      subtitle:
        "Durable, stylish, and spacious. The perfect companion for your next adventure.",
      cta: "Shop Bags",
      color: "bg-blue-600",
    },
  ];
  ...
  return (
    <div className="w-full px-4 py-4 lg:py-16 lg:px-16">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 relative h-[500px] rounded-4xl overflow-hidden group bg-gray-900">
          {/* Slide Renderer */}
