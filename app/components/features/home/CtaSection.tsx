  ...
  return (
    ...
    <section className={`py-20 px-4`} style={{ backgroundColor: colors.ctaBackground }}>
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <p className={`text-lg md:text-xl max-w-2xl mb-10 leading-relaxed`} style={{ color: colors.textPrimary }}>
        ...
        <button className={`${colors.textDefault} font-bold text-sm md:text-base px-10 py-4 rounded-full shadow-md hover:scale-105 hover:shadow-lg transform transition-all duration-300 ease-in-out`}
