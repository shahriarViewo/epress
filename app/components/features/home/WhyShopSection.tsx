      ...
      <div className="flex flex-col lg:flex-row gap-12 items-stretch">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="mb-12 max-w-2xl">
            <h2 className={`text-2xl md:text-3xl font-bold ${colors.textStrong} mb-6`}>
              Why Shop With OnePrint?
            </h2>
            <p className={`text-xs lg:text-sm ${colors.textMuted} leading-relaxed`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 gap-x-8">
            ...
            <div className="flex flex-col items-start gap-3">
              ...
              <h3 className={`text-sm lg:text-base font-semibold ${colors.textStrong}`}>
                Custom Design
              </h3>
              <p className={`text-xs lg:text-sm ${colors.textMuted} leading-relaxed`}>
