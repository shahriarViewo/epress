        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="mb-12 max-w-2xl">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              ...
              look great, and last longer. Designed with care, made for real-life moments.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 gap-x-8">
            ...
            <div className="flex flex-col items-start gap-3">
              <div className="p-0">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#E07A06" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex flex-col items-start gap-3">
              ...
              <h3 className="text-xl font-bold text-gray-900">Easy Return Policy</h3>
              <p className="text-gray-500 text-sm leading-relaxed">
